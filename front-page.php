...
?>
    ...
    <main id="primary" class="site-main">
        <section class="banner fade-in-anim fade-in-down">
            <img src="<?php echo get_template_directory_uri() . '/assets/images/logo.png'; ?> " alt="logo Fleurs d'oranger & chats errants" class="img_logo" data-0="position: absolute; top: 300px;" data-1100="top: 500px;"> 
        </section>
        ...
        <section id="studio" class="fade-in-up">
            <h2 class="title-anim title-studio"><span>Studio</span><span>Koukaki</span></h2>
            <div>
